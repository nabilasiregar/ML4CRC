...
class RandomForestModel:
    ...
    def train(self, X_train, y_train, n_estimators=100, evaluate_on_train=False):
        """
    ...
    def tune_hyperparameters(self, X_train, y_train, X_test, y_test, n_trials=100):
        ...
        # Retrain the model with the best parameters and evaluate on training set
        train_f1 = self.train(X_train, y_train, n_estimators=best_params['n_estimators'], evaluate_on_train=True)
