...
# Train KNN model
knn_model = knn_classification(features, target)
...
test_accuracy = calculate_accuracy(knn_model, test_data, test_target)
print("Accuracy on test data:", test_accuracy)

# Calculate accuracy on validation data
validation_accuracy = calculate_accuracy(knn_model, validation_data, validation_target)
